...
<div class="open-item open-item-active">
    <span class="open-item-phone flex-row" evt="wa-m"><?=Form::unsaitazePhone($phone)?> <span class="flex" style="width: 20px; hight: 20px;"><?=svg('type.' . mb_strtolower(TypeSend::get((int)$type_send) ?: 'WhatsApp')) ?></span></span>
