...
<div class="content-text">
    ...
    <? if (!$s_1 && $s_2) : ?>
        <p>Готовый комплект документов для налоговой за 2023,2022г. можно получить при личном визите в любой клинике Альтамед+. При получении пациентом достаточно предъявить паспорт. При получении справки налогоплательщиком/опекуном - паспорт и документы, подтверждающие родство (свидетельство о рождении, свидетельство о браке, копию паспорта пациента если пациент - родитель).</p>
        ...
        <p><strong>Справки начиная с 2024 года формируются в электронном формате и отправляются напрямую в ФНС.</strong> Как правило в течении недели после отправки справка появляется в Личной Кабинете налогоплательщика на сайте: <a href="https://lkfl2.nalog.ru/lkfl/" target="_blank">https://lkfl2.nalog.ru/lkfl/</a></p>
    <? else : ?>
